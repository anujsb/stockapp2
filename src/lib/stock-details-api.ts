// Comprehensive Stock API with Alpha Vantage primary and Yahoo Finance fallback
// Enhanced support for NSE/BSE stocks with CORS proxy and comprehensive fundamental data
...
const calculateTechnicalIndicators = (data: HistoricalDataPoint[]): TechnicalIndicators => {
  if (data.length === 0) {
    return {
      sma20: 0,
      sma50: 0,
